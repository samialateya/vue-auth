        ...
        let response;
				...
				switch (connection.status){
					...
					case 200: 
						...
						break;
					//invalid inputs case
					case 422:this.printErrorMessage("Id Token Is Required"); break;
					//server error case
					case 500:this.printErrorMessage("Server Error! please contact support center"); break;
					//default case
					default:this.printErrorMessage("Something went wrong, please try again later"); break;
				}
      }
